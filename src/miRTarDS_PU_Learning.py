...
def load_dictionaries(config: dict, unique_miRNAs: list, unique_genes: list):
    ...
    dic_gene_disease = process_db.load_gene_disease_dict(config['paths']['gene_dict_source'])
...
# 2       PU_XGBoost  0.736874  0.725310
# 4    Naive_XGBoost  0.719850  0.698810
# 0  PU_DecisionTree  0.698211  0.699339
# 1  PU_RandomForest  0.688497  0.689197
# 3   PU_LogisticReg  0.649085  0.645047